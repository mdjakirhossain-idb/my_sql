                ...
                <div className='flex justify-between items-center gap-2'>
                    ...
                    <div className='w-full md:w-4/12'>
                        <Search
                            ...
                            placeholder='Search data by category name...'
                        />
                    </div>
                </div>
            </div>
                ...
                <Table>
                    <Table.Thead>
                        <tr>
                            ...
                            <Table.Th className='w-40'>Name</Table.Th>
                        ...
                        {categories.data.length ?
                            ...
                            <Table.Empty colSpan={4} message={
                                <>
                                    ...
                                    <span className='text-gray-500'>Category Data</span> <span className='text-rose-500 underline underline-offset-2'>Not found.</span>
                                </>
                            } />
                        }
                    </Table.Tbody>
